...
const Footer = () => {
  return (
    ...
    >
      <div className="flex-shrink-0 w-96 mx-auto md:mx-0 md:text-left">
        ...
        <p className="mt-2 text-s text-gray-400">
          Discover, Contribute, Thrive - ContriZone: Your gateway to open-source collaboration. Empowering both seasoned contributors and beginners alike to explore, engage, and make a difference in the world of open-source projects.
        </p>
      </div>
    ...
    <div className="flex justify-center mt-4 space-x-4 lg:mt-2 py-4">
          <Link href="https://github.com/sachinkr24/contrizone" target='_blank'>
          ...
          <Link href="mailto:sachinkr24663@gmail.com" target=''>
          ...
          <Link href="https://www.linkedin.com/in/sachinkr24" target='_blank'>
    ...
    <div className="flex justify-center ">
      <p className="text-center text-gray-300 pb-4">
        &copy; {new Date().getFullYear()} All rights reserved by ContriZone.
      </p>
    </div>
  </footer>
  )
